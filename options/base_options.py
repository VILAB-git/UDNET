...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--temp_nc', type=int, default=3, help='# of output image channels: 3 for RGB and 1 for grayscale')
        ...
        parser.add_argument('--netG', type=str, default='resnet_9blocks_cond', help='specify generator architecture')
        ...
        # UNet parameters
        parser.add_argument('--n_blocks_down', type=int, default=2, help='Path to the config file')
        parser.add_argument('--n_blocks_up', type=int, default=2, help='Path to the config file')
